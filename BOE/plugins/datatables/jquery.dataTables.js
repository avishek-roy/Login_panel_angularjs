...
(/** @lends <global> */function( $ ) {
	...
	function _fnFeatureHtmlFilter ( settings )
	{
		...
		var input = '<div class="' + 'box-tools pull-right no-padding col-md-12' + '"><div class="has-feedback"><input type="text" placeholder="ddd" class="textbox-table-search' + classes.sFilterInput + '"   /> <span class="glyphicon glyphicon-search form-control-feedback pull-right"></span></div>';
